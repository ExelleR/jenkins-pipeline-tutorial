...
pipeline {
    ...
    // pipeline's stages.
     environment {
        region = "us-east-1"
        docker_repo_uri = "652727432822.dkr.ecr.us-east-1.amazonaws.com/sample-app"
        task_def_arn = "arn:aws:ecs:us-east-1:652727432822:task-definition/first-run-task-definition"
        cluster = "default"
        exec_role_arn = "arn:aws:iam::652727432822:role/ecsTaskExecutionRole"
    }
